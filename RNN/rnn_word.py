...
# Création d'un réseau neuronal récurrent (RNN) dont le but est de générer 
# mot par mot
...
#Séparation en mot
mots = tf.strings.split(text).numpy()
print(mot[:100]) # Il faut vérifier qu'on enlève bien les "\n"
